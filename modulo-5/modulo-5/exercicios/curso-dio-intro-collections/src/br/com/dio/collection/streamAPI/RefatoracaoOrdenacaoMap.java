...
public class RefatoracaoOrdenacaoMap {
    ...
    public static void main(String[] args) {
        ...
        /*Set<Map.Entry<Integer, Contato>> set = new TreeSet<>(new Comparator<Entry<Integer,
            Contato>>() {
                @Override
        ...
        /*Set<Map.Entry<Integer, Contato>> set = set = new TreeSet<>(Comparator.comparing(
        ...
        //lambda | variável -> tipo do método (expressão)
        Set<Map.Entry<Integer, Contato>> set = set = new TreeSet<>(Comparator.comparing(
